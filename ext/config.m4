...
if test "$PHP_UAMQP" != "no"; then
	...
	PHP_NEW_EXTENSION(uamqp, uamqp.c src/php/php_uamqp_connection.c src/php/php_uamqp_message.c src/uamqp/uamqp_connection.c src/uamqp/uamqp_message_sender.c, $ext_shared)
